...
class CameraAnalyzerConsultancyFeeAddNewView
    extends GetView<CameraAnalyzerConsultancyFeeAddNewController> {
  const CameraAnalyzerConsultancyFeeAddNewView({Key? key}) : super(key: key);
  @override
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              decoration: InputDecoration(
                                  hintText: "Enter Consultancy Fee",
                                  contentPadding: EdgeInsets.only(left: 5),
                                  hintStyle: TextStyle(fontSize: 8.5),
                                  enabledBorder: OutlineInputBorder(
                                      borderSide: BorderSide.none),
