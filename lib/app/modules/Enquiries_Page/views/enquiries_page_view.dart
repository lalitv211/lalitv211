...
class EnquiriesPageView extends GetView<EnquiriesPageController> {
  const EnquiriesPageView({Key? key}) : super(key: key);
  @override
            ...
            () => Column(
              children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child:
                              Image.asset("assets/images/Rectangle 33(4).png"),
                        ),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisAlignment: MainAxisAlignment.start,
                ...
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      Get.toNamed(Routes.ENQUIRIES_DETAILS);
                    },
                    child: Card(
                      color: HexColor("#DBF1FC"),
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10)),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Image.asset(
                                "assets/images/Rectangle 33(4).png"),
                          ),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.start,
                              ...
                              child: Row(
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    child: controller.forHoshangabad.value !=
                                            false
                                        ? InkWell(
                                            onTap: () {
