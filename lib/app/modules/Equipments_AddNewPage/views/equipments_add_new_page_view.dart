...
class EquipmentsAddNewPageView extends GetView<EquipmentsAddNewPageController> {
  const EquipmentsAddNewPageView({Key? key}) : super(key: key);
  @override
        ...
        child: Column(
          children: [
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  Get.toNamed(Routes.EQUIPMENTS_ON_RENT_PAGE);
                },
                icon: Icon(
                  Icons.add,
