...
class LiveVideoSettupPageView extends GetView<LiveVideoSettupPageController> {
  const LiveVideoSettupPageView({Key? key}) : super(key: key);
  @override
        ...
        child: Column(
          children: [
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  Get.toNamed(Routes.LIVE_VIDEO_SETTUP_ADD_NEW_PAGE);
                },
                icon: Icon(
                  Icons.add,
