...
class LiveVideoSettupAddNewPageView
    extends GetView<LiveVideoSettupAddNewPageController> {
  const LiveVideoSettupAddNewPageView({Key? key}) : super(key: key);
  @override
                ...
                child: Container(
                    ...
                    child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            backgroundColor: HexColor("#0D86BF")),
                        onPressed: () {
                            Get.toNamed(Routes.PHOTOGRAPHY_INSTITUTE_PRICE);
                        },
                        child: Text(
                          "Done",
                          style: TextStyle(
