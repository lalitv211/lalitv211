...
class PhotoAlbumPageView extends GetView<PhotoAlbumPageController> {
  const PhotoAlbumPageView({Key? key}) : super(key: key);
  @override
        ...
        child: Column(
          children: [
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  Get.toNamed(Routes.PHOTO_ALBUM_ADD_NEW_PAGE);
                },
                icon: Icon(
                  Icons.add,
