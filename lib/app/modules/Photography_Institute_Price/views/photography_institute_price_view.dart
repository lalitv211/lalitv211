...
class PhotographyInstitutePriceView
    extends GetView<PhotographyInstitutePriceController> {
  const PhotographyInstitutePriceView({Key? key}) : super(key: key);
  @override
        ...
        child: Column(
          children: [
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  Get.toNamed(Routes.PHOTOGRAPHY_INSTITUTE_PRICE_ADD_NEW_PAGE);
                },
                icon: Icon(
                  Icons.add,
