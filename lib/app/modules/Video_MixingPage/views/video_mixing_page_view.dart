...
class VideoMixingPageView extends GetView<VideoMixingPageController> {
  const VideoMixingPageView({Key? key}) : super(key: key);
  @override
        ...
        child: Column(
          children: [
            ...
            CircleAvatar(
              ...
              child: IconButton(
                onPressed: () {
                  Get.toNamed(Routes.VIDEO_MIXING_ADD_NEW_PAGE);
                },
                icon: Icon(
                  Icons.add,
