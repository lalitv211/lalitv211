                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Get.toNamed(Routes.ENQUIRIES_PAGE);
                            },
                            child: Text(
                              "Live Enquiry",
                              style: TextStyle(
                      ...
                      itemBuilder: (context, index) {
                        return Column(children: [
                          SizedBox(
                              ...
                              width: 60,
                              child:
                                  Image.asset('assets/old_images/img_4.png')),
                          const SizedBox(
                              width: 80,
                              child: Text(
                                "Equipment On Rent",
